...
static void run_ex2(void) {
    ...
    puts("\nExercício 2 - Xn para metade baixa de Vd");
...
static void run_ex4(void) {
    ...
    puts("\nExercício 4 - Preencher V0 com 1s");
...
static void run_ex5(void) {
    ...
    puts("\nExercício 5 - Reorganização arbitrária de bytes");
    ex5_shuffle_bytes(input, got);
    pass_bytes("padrão TBL aplicado byte a byte", got, expected, TP3_VEC_BYTES);
}
...
static void run_ex6(void) {
    ...
    puts("\nExercício 6 - Inserir word em lane específico");
...
static void run_ex7(void) {
    ...
    puts("\nExercício 7 - Shift left por 5 bits nos dois lanes de 64 bits");
...
static void run_ex9(void) {
    ...
    puts("\nExercício 9 - Dot product u16x8 com redução");
...
static void run_ex10(void) {
    ...
    puts("\nExercício 10 - Soma SIMD float32x4");
...
static void run_ex11(void) {
    ...
    puts("\nExercício 11 - Macro GAS básica de inicialização");
    ex11_macro_zero_twice(got_a, got_b);
    pass_bytes("primeira expansão da macro INIT_VEC_ZERO", got_a, expected, TP3_VEC_BYTES);
    pass_bytes("segunda expansão da macro INIT_VEC_ZERO", got_b, expected, TP3_VEC_BYTES);
}
...
int main(void) {
    puts("Validação automatizada do TP3 - NEON SIMD e macros GAS");
    puts("Execução cruzada: binário AArch64 rodando em qemu-aarch64");
